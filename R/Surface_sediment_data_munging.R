...
ggsave("plots/wholelakesed_vsthickness_jan.png", 
...
ggsave("plots/Peak_Solar_Comparison_20250408.png", 
       width = 12, height = 8, dpi = 300)
...
ggsave("plots/sed_abundance_ice_thick_timeseries.png", 
